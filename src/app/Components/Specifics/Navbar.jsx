    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center h-full space-y-12 pb-32">
          ...
          {/* Item Cuenta */}
          <div 
            className={`relative group flex flex-col items-center space-y-4 transform transition-all duration-700 ease-out ${
              isMenuOpen ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
            }`}
            style={{ transitionDelay: isMenuOpen ? '200ms' : '0ms' }}
          >
            {/* quitar cuando se implemente la cuenta */}
            <hr className='z-10 absolute border-2 border-white w-full top-[50%]'/>
            ...
            <div className='flex items-center justify-center space-x-3'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="scale-125 text-gray-600 group-hover:duration-300 animate-bounce-alt">
              ...
              <p 
                // className='hover:cursor-pointer uppercase text-white font-bold text-3xl tracking-widest group-hover:text-purple-500 group-hover:duration-300 transition-colors duration-300' 
                className='hover:cursor-pointer uppercase text-gray-600 font-bold text-3xl tracking-widest group-hover:duration-300 transition-colors duration-300' 
                onClick={aviso}
              >
                Cuenta
              </p>
