            ...
            <div className="bg-white flex p-6 rounded-xs w-2/3">
                ...
                <div className="w-1/2 flex flex-col items-start gap-y-12 justify-center">
                    ...
                    <div className="w-full flex gap-x-4 items-center justify-between">
                        <button className="group w-1/2 border-2 border-black py-2 font-semibold rounded-md bg-blue-400 hover:bg-blue-700">
                        ...
                        <button className="group w-1/2 border-2 border-black py-2 font-semibold rounded-md bg-red-400 hover:bg-red-700">
                            <p className="flex gap-x-1 justify-center items-center group-hover:text-white group-hover:scale-125 duration-300">
                                Añadir a Me Gusta
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                    ...
                    <a className="text-red-600 hover:cursor-pointer hover:scale-110 duration-300 font-semibold text-lg">¿ Tienes Preguntas ? Contactanos!</a>
                </div>
            </div>
